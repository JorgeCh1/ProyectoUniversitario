      ...
      <div className="max-w-7xl mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            <a
              href="#"
              className="text-sm text-gray-900 hover:text-gray-600 transition-colors hidden md:block"
            >
              Account
            </a>
            ...
            >
              ...
              <span className="absolute -top-1 -right-1 flex h-4 w-4 items-center justify-center rounded-full bg-black text-[10px] text-white font-medium">
                0
              </span>
            </a>
          </div>
